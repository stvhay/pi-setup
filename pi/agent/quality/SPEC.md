...
| INV-15, FAIL-13 | `tests/test_quality.py::test_inv15_canary_revalidates_grant_target_and_dispatches_once`, `test_inv15_canary_packet_separates_authorization_and_execution_evidence`, `test_inv15_canary_execution_proof_binds_claim_target_effects_and_fresh_evidence`, `test_inv15_concurrent_canary_apply_consumes_one_allowance`, `test_inv15_concurrent_same_grant_claims_reserve_one_allowance`, `test_inv15_claim_dispatch_settle_passes_explicit_token_and_releases_lock`, `test_inv15_settlement_is_idempotent_after_terminal_state`, `test_fail13_settlement_rejects_forged_claim_context`, `test_fail13_settlement_downgrades_unknown_dispatched_state_to_uncertain`, `test_fail13_dispatch_exception_settles_uncertain_and_blocks_retry`, `test_canary_legacy_packet_without_evidence_contract_is_rejected`, `test_canary_missing_or_stale_authorization_evidence_blocks_before_claim`, `test_settle_rejects_execution_evidence_outside_required_contract`; existing grant/run authority checks cover the downstream adapter guard. |
