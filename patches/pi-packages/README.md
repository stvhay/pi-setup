...
| `@pi-archimedes/footer` | 2.0.1 | Preserve Pi's keyed extension-status contract when the Archimedes custom footer replaces Pi's built-in footer. Statuses render as one sorted, sanitized, width-bounded final row. |
